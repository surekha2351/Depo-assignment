...
const Sidebar = () => {
  ...
  return (
    <nav className="hidden md:flex gap-4  flex-col min-w-[300px] max-w-[550px] bg-blue-900 border-r-2 border-gray-500 ">
      {isModalOpen ? (
      ...
      <div className="overflow-y-auto overflow-x-hidden border-t-4 border-white pt-2">
        ...
        {true ? (
          <div>
            <section className="flex justify-between items-center px-2 py-2 bg-blue-900">
              <div className="flex">
                <Avatar className="border-2 border-white">
                  <AvatarFallback>{initials}</AvatarFallback>
                </Avatar>
